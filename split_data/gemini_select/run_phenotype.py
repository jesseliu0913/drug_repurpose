...
# pheno_data = "/playpen/jesse/drug_repurpose/split_data/data/ddphenotype.jsonl"
pheno_data = "/playpen/jesse/drug_repurpose/split_data/data/dd_phenotype_negative.jsonl"
...
if args.key_idx == 0:
    ...
    user_key = "AIzaSyAsmMUeXmkOKwjmx__-rhZhyCevd5gllFc"
...
file_path = f"./output/negative/phenotype_{args.start_idx}_{args.end_idx}.jsonl"
f_write = jsonlines.open(file_path, "a")
with open(pheno_data, 'r', encoding='utf-8') as f:
...
# nohup python run_phenotype.py --start_idx 998 --end_idx 1000 --key_idx 0 > p_1.lpg 2>&1 &
# nohup python run_phenotype.py --start_idx 1962 --end_idx 2000 --key_idx 5 > p_2.lpg 2>&1 &