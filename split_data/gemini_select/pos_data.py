...
count = 0 
type = "phenotype"
pos_data = f"/playpen/jesse/drug_repurpose/split_data/gemini_select/output/positive/{type}.jsonl"
raw_data = f"/playpen/jesse/drug_repurpose/split_data/data/dd{type}.jsonl"

f_write = jsonlines.open(f"/playpen/jesse/drug_repurpose/split_data/gemini_select/data/{type}_pos.jsonl", 'a')
