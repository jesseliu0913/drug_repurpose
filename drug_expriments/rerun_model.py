...
df_correct = pd.read_csv('./results/llama32_1b_split/output_DD1K_correct.csv')
df_incorrect = pd.read_csv('./results/llama32_1b_split/output_DD1K_incorrect.csv')
...
with jsonlines.open(file_path, "a") as f_write:
  for dd_pair in df_incorrect.itertuples(index=False):
    answer_lst = []
    line_dict = {}
