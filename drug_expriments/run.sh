...
CUDA_VISIBLE_DEVICES=7 python model_run.py \
    --model_name "meta-llama/Llama-3.2-3B-Instruct" \
    --output_path "results/llama32_3b/" \
    --prompt_type "phenotype" \
    --shuffle_num 1 
...
CUDA_VISIBLE_DEVICES=6 nohup python model_run.py \
    ...
    --output_path "results/llama31_8b/" \
    --prompt_type "cot" \
    --shuffle_num 1 > ./log/llama31_8b_cot.log 2>&1 &
CUDA_VISIBLE_DEVICES=7 nohup python model_run.py \
    --model_name "meta-llama/Llama-3.1-8B-Instruct" \
    --output_path "results/llama31_8b/" \
    --prompt_type "gene" \
    --shuffle_num 1 > ./log/llama31_8b_gene.log 2>&1 &
CUDA_VISIBLE_DEVICES=7 nohup python model_run.py \
    --model_name "meta-llama/Llama-3.1-8B-Instruct" \
    --output_path "results/llama31_8b/" \
    --prompt_type "phenotype" \
    --shuffle_num 1 > ./log/llama31_8b_phenotype.log 2>&1 &
