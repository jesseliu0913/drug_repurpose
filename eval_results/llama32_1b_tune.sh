...
CUDA_VISIBLE_DEVICES=2 nohup python eval_model.py --model_name "meta-llama/Llama-3.2-1B-Instruct" --adapter_name "JesseLiu/llama32-1b-pagerank-baseline" --output_path "results/llama32_1b_pagerank_baseline/" --prompt_type "phenotype" --shuffle_num 1 > "./log/llama32_1b_tune_phenotype.log" 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python eval_model.py --model_name "meta-llama/Llama-3.2-1B-Instruct" --adapter_name "JesseLiu/llama32-1b-pagerank-baseline" --output_path "results/llama32_1b_pagerank_baseline/" --prompt_type "cot" --shuffle_num 1 > "./log/llama32_1b_tune_cot.log" 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python eval_model.py --model_name "meta-llama/Llama-3.2-1B-Instruct" --adapter_name "JesseLiu/llama32-1b-pagerank-baseline" --output_path "results/llama32_1b_pagerank_baseline/" --prompt_type "gene" --shuffle_num 1 > "./log/llama32_1b_tune_gene.log" 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python eval_model.py --model_name "meta-llama/Llama-3.2-1B-Instruct" --adapter_name "JesseLiu/llama32-1b-pagerank-baseline" --output_path "results/llama32_1b_pagerank_baseline/" --prompt_type "raw" --shuffle_num 1 > "./log/llama32_1b_tune_raw.log" 2>&1 &