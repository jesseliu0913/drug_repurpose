...
CUDA_VISIBLE_DEVICES=6 nohup python train.py --model "Qwen/Qwen2.5-7B-Instruct" --task 'qwen25' --training_data 'kpath' --train_setting 'partial' > ./log/qwen25_kpath.log 2>&1 &
CUDA_VISIBLE_DEVICES=7 nohup python train.py --model "Qwen/Qwen2.5-7B-Instruct" --task 'qwen25' --training_data 'pagerank' --train_setting 'partial' > ./log/qwen25_pagerank.log 2>&1 &
