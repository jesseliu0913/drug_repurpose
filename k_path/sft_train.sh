...
CUDA_VISIBLE_DEVICES=3 nohup python sft_train.py --model "meta-llama/Llama-3.2-3B-Instruct" --task 'llama32-3b-instruct' --data_type 'ddinter' > ./log/llama323b_ddinter.log 2>&1 &
