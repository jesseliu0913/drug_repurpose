...
combined_sample = pd.read_csv("train_paths_sampled.csv")
negative_sample = combined_sample[combined_sample['original_relation'] == 'contraindication'].copy()
positive_sample = combined_sample[combined_sample['original_relation'] == 'indication'].copy()
# combined_sample = pd.concat([positive_sample, negative_sample], ignore_index=True)
print(len(negative_sample), len(positive_sample))
def add_neg(neg):
