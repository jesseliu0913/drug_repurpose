...
train_data = Path("data/train_baseline.jsonl")
...
training_args = TrainingArguments(
    output_dir="./llama32-1b-baseline-model",
...
model.save_pretrained("./llama32-1b-baseline-final")

# CUDA_VISIBLE_DEVICES=3 nohup python baseline_tuning.py > ./log/baseline_tuning_1b.log 2>&1 &